...
public class ProgramRolesContributions extends EstatioDomainService<ProgramRole> {

    public ProgramRolesContributions() {
        super(ProgramRolesContributions.class, ProgramRole.class);
    }
    ...
    public String validateNewProgramRole(
        ...
        if(programRoles.findRole(program, party, type)!=null){
