...
public class PersonRandom extends PersonAbstract {
    ...
    protected void execute(ExecutionContext executionContext) {
        ...
        person = createPerson(getReference(), initials, getFirstName(), getLastName(), getPersonGenderType(), executionContext);
    }
}
